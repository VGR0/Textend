...
/**
 * Provides locations of system-specific directories.
 */
public class SystemDirectories
{
    private static final Logger logger =
        Logger.getLogger(SystemDirectories.class.getName());
    ...
    /**
     * Returns directory where the native system expects this application
     * to store configuration files for the current user.  No attempt is made
     * to create the directory, and no checks are done to see if it exists.
     *
     * @return directory where user data files for Textend should be stored
     */
    public static Path configDir()
    {
        return configDir("Textend");
    }
}
